                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                ?>
                                <td><?= $btn_edt ?> <a class="btn btn-danger btn-sm p-0 me-3" href='views/controls/hapus.php?vz=<?= base64_encode($student['id']) ?>' onclick="return confirm('Apakah benar ingin di hapus ?')">Hapus</a></td>
